...
const SearchBar = () => {
  return (
    <Form>
    <InputGroup  style={{borderRadius:"0px",  width:"300px",height:"38px" }}>
    <Form.Control
          type="text"
          placeholder="Search"
          className=" mr-sm-2"
          style={{borderRadius:"0px",backgroundColor:"#FFF", borderColor:"#FFF" ,color: "#999",fontSize:"13px",fontWeight:"400",width: "89px"}}
        />
          <InputGroup.Text id="basic-addon1" style={{borderRadius:"0px",backgroundColor:"#FFF", borderColor:"#FFF"}}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
